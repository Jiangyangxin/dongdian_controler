...
int main(int argc, char **argv)
{
    ...
    if (hk_name=="hk_camere1")
    {
        ...
        int target_ip1=3232235586; //表示IP地址为 192.168.0.66
   ...
   //********** 60 Hz        **********/
    ...
    {
        cout<<"hk_name:"<<hk_name<<endl;
        tf2_ros::StaticTransformBroadcaster static_T_C1_C3_pub; //两个工装相机之间的位姿关系
        geometry_msgs::TransformStamped T_C1_C3;  //两个工装相机之间的位姿关系
        //两个工装相机之间的位姿关系，需要进行双目相机标定，把结果输入进来即可
        T_C1_C3.header.frame_id = "hikrobot_camera";  
        T_C1_C3.header.stamp = ros::Time::now();  
        T_C1_C3.child_frame_id = "hikrobot_camera2"; 
        // set translation 
        T_C1_C3.transform.translation.x = 2.0;  //代表child_frame_id相对于frame_id的偏移量
        T_C1_C3.transform.translation.y = 0.15247693;  
        T_C1_C3.transform.translation.z = 0;  
        // set rotation  
        ...
        int target_ip2=3232235587; //表示IP地址为 192.168.0.67
        ...
        cv_ptr->image = src_new;
            ...
            std::vector<double> D2={-0.05920878623760449, 0.08264318027241738, 0.004728377611474319, 0.004268759332907533}; //相机2
            //-0.077658,0.238342,-0.002914,-0.001424,-0.571738
            boost::array<double, 9UL> 
            K2={1760.2201,0,760.2998,
            0,1772.4798,615.5398,
            0,0,1};
            boost::array<double, 12UL> 
            P2={1760.2201,0,760.2998,0,
            0,1772.4798,615.5398,0,
            0,0,1,0};
